...
function mergeSort(array, nivelAninhamento = 0) {
                                        // nivelAninhamento vai retorna o passo a passo do código.                            
...
function ordena(parte1, parte2) {
    ...
    return resultado.concat(posicaoAtualParte1 < parte1.length
        ? parte1.splice(posicaoAtualParte1)
...
//Fornece um stack trace (rastreamento de pilha) completo, com informações sobre os locais, módulos ou arquivos em que os métodos são chamados.
